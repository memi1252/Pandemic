...
namespace TextInspectSystem
{
    public class TextInspectUIManager : MonoBehaviour
    {
        ...
        [SerializeField] public GameObject objectNameBG;
        ...
        [Header("coolTimeBar")]
        [SerializeField] private GameObject coolTimeBar;
        [SerializeField] private Image coolTimeBarImage;
        ...
        {
            coolTimeBar.SetActive(on);
        }
        
        public void UpdateCoolTimeBar(float fillAmount)
        {
            coolTimeBarImage.fillAmount = fillAmount;
        }
        
        public bool ShowCoolTimeBarCkeck()
        {
            return coolTimeBar.activeSelf;
        }
    }
}
